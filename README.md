# Курсовая работа на профессии "DevOps-инженер с нуля" - Петр Петров
### Задача  
...
Разобьем задание на этапы:
1. Подготовка аккаунта и инструментов.  


1. Подготовка аккаунта и инструментов:  

1. Создаем сервисный аккаунт в Yandex Cloud с ролью Editor.  
